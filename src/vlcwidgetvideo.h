...
*/
#if defined(Q_OS_MAC)
class VlcWidgetVideo : public QMacCocoaViewContainer, public VlcVideoDelegate
#else
class VlcWidgetVideo : public QWidget, public VlcVideoDelegate
#endif
{
Q_OBJECT
public:
