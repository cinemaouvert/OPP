...
class PlaylistTableView : public QTableView
{
    Q_OBJECT
public:
    explicit PlaylistTableView(MainWindow* mainWindow, PlaylistTabWidget* playlistTabWidget, int tabIndex, QWidget *parent = 0);
    virtual ~PlaylistTableView();

    void setModel(PlaylistModel *model);

    /**
     * @brief the current PlaylistTableView is shown or hidden
     * @return
     */
    bool shown();
...
public slots:
    ...
    /**
     * @brief select the playing item or do nothing
     */
    void selectPlayingItem();
...
private slots:
    ...
    /**
     * @brief toggleIconParentTab
     */
    void toggleIconParentTab();
...
private:
    ...
    /**
     * @brief The index in the tab widget where the current table view is located
     */
    int _tabIndex;
